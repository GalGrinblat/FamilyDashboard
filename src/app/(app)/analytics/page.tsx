        ...
        <div className="flex-1 space-y-4 p-8 pt-6">
            <div className="flex items-center justify-between space-y-2 mb-6">
                <div>
                    ...
                    <p className="text-muted-foreground mt-1 text-sm">ניתוח נתונים אוטומטי המבוסס על תנועות העו״ש שלך.</p>
                </div>
                ...
                <div className="col-span-1 md:col-span-3 mt-2">
                    <Card className="shadow-sm border-zinc-200 dark:border-zinc-800 bg-indigo-50 dark:bg-indigo-950/20">
                        ...
                        <CardContent className="flex flex-col items-center justify-center p-12 text-center h-[230px]">
                            <span className="text-5xl font-black text-indigo-700 dark:text-indigo-300 mb-2" dir="ltr">
