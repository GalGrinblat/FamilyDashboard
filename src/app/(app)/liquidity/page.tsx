...
import { LiquidityAccountsTab } from "@/components/finance/LiquidityAccountsTab";
import { RecurringFlowsTable } from "@/components/finance/RecurringFlowsTable";
            ...
            <div className="pt-8">
                <Card className="border-indigo-100 dark:border-indigo-900 shadow-sm overflow-hidden">
                    <CardHeader className="bg-indigo-50/30 dark:bg-indigo-900/10">
                        <CardTitle className="text-indigo-800 dark:text-indigo-300">תקציב ותזרים קבוע (Recurring Flows)</CardTitle>
                        <CardDescription>
