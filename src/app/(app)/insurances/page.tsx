                    ...
                    <Card>
                        <CardHeader className="flex flex-row items-center justify-between pb-2">
                            <div>
                                ...
                                <CardDescription className="mt-1">ביטוחי בריאות פרטיים, קופות חולים וביטוחי חיים/משכנתא.</CardDescription>
                            </div>
                            <PolicyDialog defaultType={INSURANCE_TYPES.HEALTH} triggerButton={
                                <Button size="sm">
                ...
                <TabsContent value={INSURANCE_TYPES.PROPERTY} className="space-y-4">
                    <Card>
                        <CardHeader className="flex flex-row items-center justify-between pb-2">
                            ...
                            <PolicyDialog defaultType={INSURANCE_TYPES.PROPERTY} triggerButton={
                                <Button size="sm">
                                    <Plus className="ml-2 w-4 h-4" />
                                    פוליסה חדשה
                                </Button>
                    ...
                    <Card>
                        <CardHeader className="flex flex-row items-center justify-between pb-2">
                            <div>
                                ...
                                <CardDescription className="mt-1">תאריכי חידוש ומעקב הוצאות ביטוח לרכבים.</CardDescription>
                            </div>
                            <PolicyDialog defaultType={INSURANCE_TYPES.VEHICLE} triggerButton={
                                <Button size="sm">
                                    <Plus className="ml-2 w-4 h-4" />
                                    פוליסה חדשה
                                </Button>
