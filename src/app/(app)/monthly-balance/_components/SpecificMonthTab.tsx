...
export function SpecificMonthTab() {
    ...
    const currentMonthLabel = currentDate.toLocaleDateString('he-IL', { month: 'long', year: 'numeric' })
    ...
    return (
        <div className="space-y-6">
            <div className="flex items-center justify-between">
                ...
                <Button variant="outline" onClick={() => setCurrentDate(new Date())}>החודש הנוכחי</Button>
            </div>
