...
export function MobileNav() {
  ...
  return (
    <div
      className="fixed bottom-0 left-0 right-0 z-50 flex h-16 w-full items-center justify-around border-t border-zinc-200 bg-white px-2 py-2 dark:border-zinc-800 dark:bg-zinc-950 md:hidden"
      dir="rtl"
    >
      {links.map((link) => {
