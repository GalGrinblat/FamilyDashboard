      ...
      <div className="fixed bottom-20 left-4 z-50 md:hidden">
        <DropdownMenu>
          <DropdownMenuTrigger asChild>
            <Button
              size="icon"
              className="h-14 w-14 rounded-full shadow-lg hover:shadow-xl bg-indigo-600 hover:bg-indigo-700 text-white dark:bg-indigo-500 dark:hover:bg-indigo-600 border-none"
            >
        ...
        <div className="fixed inset-0 z-[100] flex items-center justify-center bg-black/50 p-4">
          <div className="bg-white dark:bg-zinc-950 p-6 rounded-lg shadow-xl w-full max-w-md relative">
            <button
              ...
              className="absolute top-4 left-4 text-zinc-500 hover:text-zinc-900 dark:hover:text-zinc-100"
            >
              X
            </button>
