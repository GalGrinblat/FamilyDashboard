...
type RecurringFlowRow = Database['public']['Tables']['recurring_flows']['Row'] & { accounts?: { name: string } | null };
...
export function ChangePaymentMethodDialog({
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        const targetAccountName = accounts.find(a => a.id === selectedAccountId)?.name || "חשבון לא מוכר";
        ...
        <Dialog open={open} onOpenChange={setOpen}>
            ...
            <DialogContent className="sm:max-w-[425px]" dir="rtl">
                <DialogHeader>
                    ...
                    <DialogDescription>
                        פעולה זו תיצור משימה (תזכורת) להחליף את אמצעי התשלום של ההוצאה הקבועה במוסד הפיננסי (למשל ספק האינטרנט או הביטוח).
                    </DialogDescription>
                </DialogHeader>
