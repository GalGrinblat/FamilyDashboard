...
export function StatementUploadEngine({ onUploadComplete }: { onUploadComplete: (data: ParsedTransactionRow[]) => void }) {
    ...
    return (
        <Card className="border-dashed border-2 bg-zinc-50 dark:bg-zinc-900/50">
            <CardHeader className="text-center pb-2">
                ...
                <CardDescription>גרור ושחרר קובץ אקסל או CSV שהורדו ישירות מהבנק או מחברת האשראי</CardDescription>
            </CardHeader>
            <CardContent>
                <div
                    ...
                    {isParsing ? (
                        ...
                        <div className="flex flex-col items-center space-y-4">
                            ...
                            <div className="space-y-1">
                                ...
                                <p className="text-sm text-muted-foreground">תמיכה מלאה ב-Excel וב-CSV (לדוגמה: ישראכרט, כאל, לאומי)</p>
                            </div>
                        </div>
                    )}
                </div>
